...
export function LensParams({ slmId, modeIndex, params }) {
  ...
  return (
    <div>
      <LabelledSlider label="f" tooltipKey="lensFocalLength" unitLabel="mm" value={p.focalLengthMm} onChange={(v) => updateModeParam(slmId, modeIndex, 'focalLengthMm', v)} min={-5000} max={5000} step={10} />
